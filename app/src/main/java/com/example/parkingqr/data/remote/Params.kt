...
object Params{
    ...
    const val CAMERA_PATH_COLLECTION = "cameras"
    const val WAITING_RATE_PATH_COLLECTION = "waitingRates"
    const val DEBT_INVOICE_PATH_COLLECTION = "debtInvoices"
    ...
    const val PARKING_LOT_STORAGE_PATH = "parking_lot_image"
